...
def build_fact_distributor_orders(
    ...
    stamp audit columns — both dims are simple (non-SCD2) business keys, so a plain left join
    can't fan out and no as-of join is needed. Measures (fill_rate_pct, ontime_delivery) and
    lineage cols pass through."""
