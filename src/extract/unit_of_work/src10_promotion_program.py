"""SRC10 promotion program — delegates to process_source()."""
...
SOURCE_FILE = "SRC10_promotion_program.xlsx"


def run(raw_dir: str, run_date: str, batch_id: str) -> tuple[pl.DataFrame | None, dict]:
    """Process SRC10_promotion_program.xlsx through process_source()."""
